...
export interface ReportTicketsInterface extends utils.Interface {
  functions: {
    "MAX_SUPPLY()": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "color(uint256)": FunctionFragment;
    "generalTicketPrice()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "generalTicketPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "milestoneTicketHolders",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface ReportTickets extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReportTicketsInterface;
  ...
  functions: {
    ...
    generalTicketPrice(overrides?: CallOverrides): Promise<[BigNumber]>;
